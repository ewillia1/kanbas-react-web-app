...
function Counter() {
    ...
    return (
        <div>
            ...
            <button className="btn btn-success me-2 mb-4" onClick={() => setCount(count + 1)}>Up</button>
            <button className="btn btn-danger mb-4" onClick={() => setCount(count - 1)}>Down</button>
        </div>
    );
}

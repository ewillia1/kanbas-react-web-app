...
export const initialState = {                              // Create reducer's initial state with 
    ...
    quiz: { title: "Unnamed Quiz", subtitle: "New Subtitle", description: "", dueDate: "2024-09-19", 
                  availableFromDate: "2024-09-24", untilDate: "2024-12-01", points: "0" }     // Default quiz.
};
...
const quizzesSlice = createSlice({ name: "quizzes", initialState,   // Create slice. Name the slice. Set initial state.
    reducers: {                                     // Declare reducer functions.
        ...
        addQuiz: (state, action) => {             // New quiz is in action.payload.
            ...
            state.quiz = { title: "Unnamed Quiz", subtitle: "New Subtitle", description: "", dueDate: "2024-09-19", 
                                 availableFromDate: "2024-09-24", untilDate: "2024-12-01", points: "0" };  // Clear quiz.
        },
